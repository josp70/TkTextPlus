...
#define STEXT_DIFF
#ifdef STEXT_DIFF
#define TkUndoPushStack SUndoPushStack
#define TkUndoPopStack SUndoPopStack
#define TkUndoInsertSeparator SUndoInsertSeparator
#define TkUndoClearStack SUndoClearStack
#define TkUndoInitStack SUndoInitStack
#define TkUndoSetDepth SUndoSetDepth
#define TkUndoClearStacks SUndoClearStacks
#define TkUndoFreeStack SUndoFreeStack
#define TkUndoInsertUndoSeparator SUndoInsertUndoSeparator
#define TkUndoMakeCmdSubAtom SUndoMakeCmdSubAtom
#define TkUndoMakeSubAtom SUndoMakeSubAtom
#define TkUndoPushAction SUndoPushAction
#define TkUndoRevert SUndoRevert
#define TkUndoApply SUndoApply
#endif
