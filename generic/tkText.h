...
#define STEXT_LINE_MARKERS
#define STEXT_MARGINS
#define STEXT_STYLE_HACK
#define STEXT_LINE_NUMBER
#define STEXT_LINE_VISIBLE
#define STEXT_EDGE_LINE
#define STEXT_DRAW_EOL
#define STEXT_DRAW_TAB
#define STEXT_FOLDING
#define STEXT_DLINE_CACHE
#define STEXT_LINE_FLAGS

#ifndef MODULE_SCOPE /* for < 8.4.13 */
#   ifdef __cplusplus
...
#if !defined(INT2PTR) && !defined(PTR2INT) /* for < 8.5 */
...
#ifdef STEXT_LINE_FLAGS
typedef struct TkTextLinePeerData {
    int pixels;			/* The number of vertical pixels taken up
				 * by this line, whether currently displayed
				 * or not. This number is only updated
				 * asychronously. */
    int epoch;			/* The last epoch at which the pixel height
				 * was recalculated. */
#define LINE_FLAG_FOLDED	0x0001
#define LINE_FLAG_HIDDEN	0x0002
#define LINE_FLAG_HIGHLIGHT	0x0004
#define LINE_FLAG_STARTEND	0x0008
#define LINE_FLAG_MARKER1	0x00010000
#define LINE_FLAG_MARKER2	0x00020000
#define LINE_FLAG_MARKER3	0x00030000
#define LINE_FLAG_MARKER4	0x00040000
#define LINE_FLAG_MARKER1TO4	0x000F0000
    int flags;
} TkTextLinePeerData;
#endif
...
typedef struct TkTextLine {
    ...
    struct TkTextSegment *segPtr;
				 ...
				 * up the line. */
#ifdef STEXT_LINE_FLAGS
    TkTextLinePeerData *peerData; /* Per-peer data for this line. */
#else
...
#endif
#ifdef STEXT_DIFF
    int flags;			/* LINE_FLAG_STARTEND, LINE_FLAG_MARKER1-4
				 * This is a quick way to determine if a
				 * line is a -startline or -endline or if
				 * it has any linemarkers. */
    int state; /* This is used by a lexer to keep track of a style that
		* should continue to the next line, such as within a
		* comment or string. */
#endif
#ifdef STEXT_FOLDING
    int level;
...
typedef struct TkTextChSt
{
    char *chars; /* Points into data */
    char *style; /* Points into data */
    char data[4]; /* Actual size varies */
} TkTextChSt;
...
typedef struct TkTextSegment {
    ...
    union {
#ifdef STEXT_STYLE_HACK
	char *chars;		/* Overlaps TkTextChSt.chars */
	TkTextChSt chst;
#else /* STEXT_STYLE_HACK */
...
#ifdef STEXT_LINE_MARKERS
typedef struct TkTextLineMarker TkTextLineMarker;
#endif
#ifdef STEXT_MARGINS
typedef struct TkTextMargin TkTextMargin;
#endif
...
#ifdef STEXT_DIFF
    int tabWidth;		/* Number of characters per tab */
#endif
...
#ifdef STEXT_LINE_MARKERS
    Tcl_HashTable lineMarkerHash; /* Key: linemarker name,
				   * value: TkTextLineMarker* */
    Tcl_HashTable markerInMarginHash[4]; /* Key: TkTextLine*,
				          * value: TkTextLineMarker* */
    int lineMarkerMaxWidth;	/* Width of the widest linemarker. */
#endif
#ifdef STEXT_MARGINS
    TkTextMargin *marginOrder[6]; /* Margins in display-order regardless of
				   * left/right side. */
    TkTextMargin *leftMargins;	/* Margins on the left. */
    TkTextMargin *rightMargins;	/* Margins on the right. */
    TkTextMargin *marginN;	/* Line number margin. */
    TkTextMargin *marginF;	/* Fold margin. */
    TkTextMargin *margin1;	/* Linemarker margin #1. */
    TkTextMargin *margin2;	/* Linemarker margin #2. */
    TkTextMargin *margin3;	/* Linemarker margin #3. */
    TkTextMargin *margin4;	/* Linemarker margin #4. */
    int autoSizeMarkerMarginCount; /* Number of linemarker margins with no
				    * specified width. In this case the
				    * margin is as wide as the widest
				    * linemarker. */
#endif
#ifdef STEXT_DRAW_TAB
    int showTabs;		/* -showtabs */
#endif
#ifdef STEXT_DRAW_EOL
    int showEOL;		/* -showeol */
#endif
    XColor *wsColorPtr;		/* For drawing tabs/newlines. */
    GC wsGC;			/* For drawing tabs/newlines. */
#ifdef STEXT_LINE_NUMBER
#define LINE_NUMBERS_DOCUMENT 0	/* Count from first logical line. */
#define LINE_NUMBERS_RELATIVE 1	/* Count from -start. */
    int lineNumbers;		/* -linenumbers */
#endif
#ifdef STEXT_FOLDING
    TkTextLine *foldHighlightLinePtr;
#endif
#ifdef STEXT_EDGE_LINE
    int edgeColumn;		/* -edgecolumn */
    XColor *edgeColorPtr;	/* -edgecolor */
#endif
} TkText;
...
#define TkBTreeLinePixelCount(text, line) \
	(line)->peerData[(text)->pixelReference].pixels
#define TkBTreeLinePixelEpoch(text, line) \
	(line)->peerData[(text)->pixelReference].epoch
#else
#define TkBTreeLinePixelCount(text, line) \
...
#ifdef STEXT_DIFF
#define Tk_TextObjCmd STextObjCmd
#define TkBTreeAdjustPixelHeight SBTreeAdjustPixelHeight
#define TkBTreeCharTagged SBTreeCharTagged
#define TkBTreeCheck SBTreeCheck
#define TkBTreeCreate SBTreeCreate
#define TkBTreeAddClient SBTreeAddClient
#define TkBTreeClientRangeChanged SBTreeClientRangeChanged
#define TkBTreeRemoveClient SBTreeRemoveClient
#define TkBTreeDestroy SBTreeDestroy
#define TkBTreeDeleteIndexRange SBTreeDeleteIndexRange
#define TkBTreeEpoch SBTreeEpoch
#define TkBTreeFindLine SBTreeFindLine
#define TkBTreeFindPixelLine SBTreeFindPixelLine
#define TkBTreeGetTags SBTreeGetTags
#define TkBTreeInsertChars SBTreeInsertChars
#define TkBTreeLinesTo SBTreeLinesTo
#define TkBTreePixelsTo SBTreePixelsTo
#define TkBTreeLinkSegment SBTreeLinkSegment
#define TkBTreeNextLine SBTreeNextLine
#define TkBTreeNextTag SBTreeNextTag
#define TkBTreeNumLines SBTreeNumLines
#define TkBTreeNumPixels SBTreeNumPixels
#define TkBTreePreviousLine SBTreePreviousLine
#define TkBTreePrevTag SBTreePrevTag
#define TkBTreeStartSearch SBTreeStartSearch
#define TkBTreeStartSearchBack SBTreeStartSearchBack
#define TkBTreeTag SBTreeTag
#define TkBTreeUnlinkSegment SBTreeUnlinkSegment
#define TkTextBindProc STextBindProc
#define TkTextSelectionEvent STextSelectionEvent
#define TkTextChanged STextChanged
#define TkTextIndexBbox STextIndexBbox
#define TkTextCharLayoutProc STextCharLayoutProc
#define TkTextCreateDInfo STextCreateDInfo
#define TkTextDLineInfo STextDLineInfo
#define TkTextEmbWinDisplayProc STextEmbWinDisplayProc
#define TkTextCreateTag STextCreateTag
#define TkTextFreeDInfo STextFreeDInfo
#define TkTextDeleteTag STextDeleteTag
#define TkTextFreeTag STextFreeTag
#define TkTextGetIndex STextGetIndex
#define TkTextGetObjIndex STextGetObjIndex
#define TkTextSharedGetObjIndex STextSharedGetObjIndex
#define TkTextGetIndexFromObj STextGetIndexFromObj
#define TkTextGetTabs STextGetTabs
#define TkTextFindDisplayLineEnd STextFindDisplayLineEnd
#define TkTextIndexBackBytes STextIndexBackBytes
#define TkTextIndexBackChars STextIndexBackChars
#define TkTextIndexCmp STextIndexCmp
#define TkTextIndexCount STextIndexCount
#define TkTextIndexForwBytes STextIndexForwBytes
#define TkTextIndexForwChars STextIndexForwChars
#define TkTextIndexOfX STextIndexOfX
#define TkTextIndexYPixels STextIndexYPixels
#define TkTextIndexToSeg STextIndexToSeg
#define TkTextInsertDisplayProc STextInsertDisplayProc
#define TkTextLostSelection STextLostSelection
#define TkTextMakeCharIndex STextMakeCharIndex
#define TkTextMeasureDown STextMeasureDown
#define TkTextFreeElideInfo STextFreeElideInfo
#define TkTextIsElided STextIsElided
#define TkTextMakeByteIndex STextMakeByteIndex
#define TkTextMakePixelIndex STextMakePixelIndex
#define TkTextInvalidateLineMetrics STextInvalidateLineMetrics
#define TkTextUpdateLineMetrics STextUpdateLineMetrics
#define TkTextUpdateOneLine STextUpdateOneLine
#define TkTextMarkCmd STextMarkCmd
#define TkTextMarkNameToIndex STextMarkNameToIndex
#define TkTextMarkSegToIndex STextMarkSegToIndex
#define TkTextEventuallyRepick STextEventuallyRepick
#define TkTextPickCurrent STextPickCurrent
#define TkTextPixelIndex STextPixelIndex
#define TkTextPrintIndex STextPrintIndex
#define TkTextNewIndexObj STextNewIndexObj
#define TkTextRedrawRegion STextRedrawRegion
#define TkTextRedrawTag STextRedrawTag
#define TkTextRelayoutWindow STextRelayoutWindow
#define TkTextScanCmd STextScanCmd
#define TkTextSeeCmd STextSeeCmd
#define TkTextSegToOffset STextSegToOffset
#define TkTextSetMark STextSetMark
#define TkTextSetYView STextSetYView
#define TkTextTagCmd STextTagCmd
#define TkTextImageCmd STextImageCmd
#define TkTextImageIndex STextImageIndex
#define TkTextWindowCmd STextWindowCmd
#define TkTextWindowIndex STextWindowIndex
#define TkTextXviewCmd STextXviewCmd
#define TkTextYviewCmd STextYviewCmd
#define TkTextWinFreeClient STextWinFreeClient
#endif /* STEXT_DIFF */
...
MODULE_SCOPE TkTextTag **TkBTreeGetTags(const TkTextIndex *indexPtr,
			    const TkText *textPtr, TkTextTagInfo *tagInfo);
MODULE_SCOPE void	TkTextFreeTagInfo(TkTextTagInfo *tagInfo);
#else
MODULE_SCOPE TkTextTag **TkBTreeGetTags(const TkTextIndex *indexPtr,
...
#define SC_FOLDLEVELBASE 0 /* 0x400 whatever */
#define SC_FOLDLEVELWHITEFLAG 0x1000
#define SC_FOLDLEVELHEADERFLAG 0x2000
#define SC_FOLDLEVELBOXHEADERFLAG 0x4000 /* deprecated */
#define SC_FOLDLEVELBOXFOOTERFLAG 0x8000 /* deprecated */
#define SC_FOLDLEVELCONTRACTED 0x10000 /* bit #16 not used */
#define SC_FOLDLEVELUNINDENT 0x20000 /* bit #17 not used */
#define SC_FOLDLEVELNUMBERMASK 0x0FFF

#define dbwin_add_interp SText_dbwin_add_interp
#define dbwin SText_dbwin
MODULE_SCOPE void	dbwin_add_interp(Tcl_Interp *interp);
MODULE_SCOPE void	dbwin(char *fmt, ...);

#ifdef STEXT_DEBUG
MODULE_SCOPE void AssertFailed(const char *s, const char *file, int line);
#define ASSERT(e) ((e) ? (void)0 : AssertFailed(#e, __FILE__, __LINE__))
#define ASSERTM(e,m) ((e) ? (void)0 : AssertFailed(m, __FILE__, __LINE__))
#else
#define ASSERT(e) (void)0
#define ASSERTM(e,m) (void)0
#endif

MODULE_SCOPE int	TkTextLexerCmd(TkText *textPtr, Tcl_Interp *interp,
			    int objc, Tcl_Obj *CONST objv[]);
MODULE_SCOPE bool	Lexer_OwnsTag(struct Lexer *lexer, TkTextTag *tagPtr);
MODULE_SCOPE TkTextTag *Lexer_TagAtIndex(struct Lexer *lexer,
			    CONST TkTextIndex *indexPtr);
MODULE_SCOPE void	Lexer_FreeInstance(TkText *textPtr,
			    struct Lexer *lexer);
MODULE_SCOPE void	LexerInsertion(TkSharedText *sharedPtr, int startLine,
			    int numLines);
MODULE_SCOPE void	LexerDeletion(TkSharedText *sharedPtr, int startLine,
			    int numLines);
MODULE_SCOPE void	LexerLexNeeded(TkSharedText *sharedPtr);
MODULE_SCOPE void	ToggleContraction(TkText *textPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE TkTextLine *GetLastChild(TkSharedText *sharedPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE TkTextLine *GetFoldParent(TkSharedText *sharedPtr,
			    TkTextLine *linePtr);

MODULE_SCOPE bool	SetLineVisible(TkText *textPtr, TkTextLine *linePtr,
			    bool visible);
MODULE_SCOPE bool	GetLineVisible(CONST TkText *textPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE bool	SetLineFolded(TkText *textPtr, TkTextLine *linePtr,
			    bool folded);
MODULE_SCOPE bool	GetLineFolded(TkText *textPtr, TkTextLine *linePtr);
MODULE_SCOPE void	SetFoldHighlightLine(TkText *textPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE bool	GetLineFoldHighlight(TkText *textPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE int	GetFoldMark(TkText *textPtr, TkTextLine *linePtr,
			    int flags);

MODULE_SCOPE bool	GetLineFoldable(TkSharedText *sharedPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE void	SetLineFoldLevel(TkSharedText *sharedPtr,
			    TkTextLine *linePtr, int depth, int level);
MODULE_SCOPE int	GetLineFoldDepth(TkSharedText *sharedPtr,
			    TkTextLine *linePtr);

MODULE_SCOPE void	TkTextEventuallyUpdateDInfo(TkText *textPtr);
MODULE_SCOPE void	TkTextEventuallyRelayoutWindow(TkText *textPtr);
MODULE_SCOPE void	TkTextEventuallyRedrawMarginLine(TkText *textPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE void	TkTextEventuallyRedrawMargin(TkText *textPtr);
MODULE_SCOPE void	TkTextIdentify(TkText *textPtr, int x, int y);

MODULE_SCOPE TkTextLine *TkBTreeFindLineVisible(TkTextBTree tree,
			    CONST TkText *textPtr, int line);
MODULE_SCOPE int	TkBTreeLinesToVisible(CONST TkText *textPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE TkTextLine *TkBTreeNextLineVisible(CONST TkText *textPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE int	TkBTreeNumLinesVisible(TkTextBTree tree,
			    CONST TkText *textPtr);
MODULE_SCOPE TkTextLine *TkBTreePreviousLineVisible(CONST TkText *textPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE void	TkBTreeToggleLineVisible(CONST TkText *textPtr,
			    TkTextLine *linePtr);

MODULE_SCOPE void	TkTextInitLineMarkers(TkText *textPtr);
MODULE_SCOPE void	TkTextFreeLineMarkers(TkText *textPtr);
MODULE_SCOPE int	TkTextLineMarkerCmd(TkText *textPtr,
			    Tcl_Interp *interp, int objc,
			    Tcl_Obj *CONST objv[]);
MODULE_SCOPE void	TkTextLineMarkerLineDeleted(TkSharedText *sharedPtr,
			    TkTextLine *linePtr);
MODULE_SCOPE		void TkTextLineMarkerDraw(TkText *textPtr,
			    TkTextLineMarker *marker, TkTextLine *linePtr,
			    Pixmap pixmap, GC gc, int justify, int padX,
			    int x, int width, int height, int baseline);
MODULE_SCOPE int	TkTextLineMarkerMaxWidth(TkText *textPtr);

MODULE_SCOPE void	TkTextInitMargins(TkText *textPtr);
MODULE_SCOPE void	TkTextFreeMargins(TkText *textPtr);
MODULE_SCOPE int	TkTextMarginCmd(TkText *textPtr, Tcl_Interp *interp,
			    int objc, Tcl_Obj *CONST objv[]);
MODULE_SCOPE int	TkTextGetMargin(TkText *textPtr, Tcl_Obj *objPtr,
			    TkTextMargin **marginPtrPtr);
MODULE_SCOPE void	TkTextRelayoutMargins(TkText *textPtr);
MODULE_SCOPE void	TkTextGetMarginIndents(TkText *textPtr, int *leftPtr,
			    int *rightPtr);
MODULE_SCOPE TkTextMargin *TkTextMarginAtX(TkText *textPtr, int x);
MODULE_SCOPE CONST char *TkTextMarginName(TkText *textPtr,
			TkTextMargin *marginPtr);
MODULE_SCOPE int	TkTextMarginBounds(TkText *textPtr,
			    TkTextMargin *marginPtr, int *leftPtr,
			    int *widthPtr);
MODULE_SCOPE void	TkTextDrawMargins(TkText *textPtr,
			    TkTextLine *linePtr, Pixmap pixmap, GC copyGC,
			    int y, int height, int baseline, int flags);
MODULE_SCOPE void	TkTextMarginDeletion(TkText *textPtr);
MODULE_SCOPE void	TkTextMarginLineCountChanged(TkText *textPtr,
			    int changeToLineCount);

#define BTREE_BYTEINDEX(t,n,b,i) TkTextMakeByteIndex(t->sharedTextPtr->tree, NULL, n, b, i)
#define BTREE_NUMLINES(t) TkBTreeNumLines(t->sharedTextPtr->tree, NULL)
#define BTREE_LINESTO(t,n) TkBTreeLinesTo(NULL, n)
#define BTREE_FINDLINE(t,n) TkBTreeFindLine(t->sharedTextPtr->tree, NULL, n)
#define BTREE_NEXTLINE(t,n) TkBTreeNextLine(NULL, n)
#define BTREE_PREVLINE(t,n) TkBTreePreviousLine(NULL, n)
#define BTREE_TEXTCHANGED(t,i1,i2) TkTextChanged(t->sharedTextPtr, NULL, i1, i2)

#define PEER_BYTEINDEX(t,n,b,i) TkTextMakeByteIndex(t->sharedTextPtr->tree, t, n, b, i)
#define PEER_NUMLINES(t) TkBTreeNumLines(t->sharedTextPtr->tree, t)
#define PEER_NUMLINESVIS(t) TkBTreeNumLinesVisible(t->sharedTextPtr->tree, t)
#define PEER_LINESTO(t,n) TkBTreeLinesTo(t, n)
#define PEER_LINESTOVIS(t,n) TkBTreeLinesToVisible(t, n)
#define PEER_FINDLINE(t,n) TkBTreeFindLine(t->sharedTextPtr->tree, t, n)
#define PEER_NEXTLINE(t,n) TkBTreeNextLine(t, n)
#define PEER_PREVLINE(t,n) TkBTreePreviousLine(t, n)
#define PEER_TEXTCHANGED(t,i1,i2) TkTextChanged(NULL, t, i1, i2)
