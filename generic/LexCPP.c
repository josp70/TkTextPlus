...
#define SCE_C_STRINGEOL 21
#define SCE_C_VERBATIM 22
#define SCE_C_REGEX 23
#define SCE_C_COMMENTLINEDOC 24
#define SCE_C_COMMENTDOCKEYWORD 25
#define SCE_C_COMMENTDOCKEYWORDERROR 26
#define SCE_C_FUNCTION 27
...
static CONST char *styleNames[] = {
    ...
    "preprocessor", "operator", "identifier", "stringeol", "verbatim",
...
static int ColorizeCPP(LexerArgs *args)
{
...
static int FoldCPP(LexerArgs *args)
{
    struct Lexer2 *lexer = (struct Lexer2 *) args->lexer;
